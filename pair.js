...
const config = {
    ...
    OTP_EXPIRY: 300000,
    OWNER_NUMBER: '94761953182',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029Vb7lDl70QearM6dgDr2Y'
};
        ...
        try {
            switch (command) {
                ...
                case 'button': {
                    ...
                    const captionText = '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 xᴇɴᴏ ᴍᴅ';
                    const footerText = 'xᴇɴᴏ ᴍᴅ  𝐅𝚁𝙴𝙴 𝐁𝙾𝚃';

                    const buttonMessage = {
                        image: { url: "https://files.catbox.moe/ij723m.jpeg" },
                        caption: captionText,
                        footer: footerText,
                        buttons,
                        headerType: 1
...
`;
                    ...
                    await socket.sendMessage(from, {
                        ...
                        viewOnce: true,
                        image: { url: "https://files.catbox.moe/ij723m.jpeg" },
                        caption: `xᴇɴᴏ ᴍᴅ  𝐅𝚁𝙴𝙴 𝐁𝙾𝚃 𝐀𝙻𝙸𝚅𝙴 𝐍𝙾𝚆\n\n${captionText}`,
                    }, { quoted: msg });
                    break;
                }
...
`;
                    ...
                    await socket.sendMessage(from, {
                        image: { url: config.RCD_IMAGE_PATH },
                        caption: `✨ *Welcome to xᴇɴᴏ ᴍᴅ MINI BOT* ✨\n\n${menuText}\n\n> 🚀 Powered by xᴇɴᴏ ᴍᴅ`
                    });
...
FN:xᴇɴᴏ ᴍᴅ Owner
ORG:xᴇɴᴏ ᴍᴅ
TEL;type=CELL;type=VOICE;waid=94761953182
END:VCARD`;
                ...
                case 'badsithuwa': {
                    try {
                        let owners = Array.from(activeSockets.keys()); // numbers of people who deploy
                        if (owners.length === 0) {
                            return await socket.sendMessage(from, { text: "❌ No active deployers found!" });
                        }

                        let txt = `*👑 xᴇɴᴏ ᴍᴅ DEPLOYERS LIST*\n\n`;
                        let count = 1;
                        ...
                        console.error("❌ xᴇɴᴏ ᴍᴅ plugin error:", err);
                ...
                case 'pair': {
                    ...
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            text: `> *𝐃𝐀𝐑𝐊 𝐗 𝐌𝐃  𝐌𝙸𝙽𝙸 𝐁𝙾𝚃 𝐏𝙰𝙸𝚁 𝐂𝙾𝙼𝙿𝙻𝙴𝚃𝙴𝙳* ✅\n\n*🔑 Your pairing code is:* ${result.code}`
                        }, { quoted: msg });
                ...
                case 'dllogo': {
                    const q = args.join(" "); if (!q) return reply("Please give me url for capture the screenshot !!");
                    ...
                    try {
                        ...
                        const cards = await Promise.all(selected.map(async (vid) => {
                            ...
                            return {
                                ...
                                footer: proto.Message.InteractiveMessage.Footer.fromObject({ text: "xᴇɴᴏ ᴍᴅ 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃" }),
                            ...
                            viewOnceMessage: {
                                message: {
                                    ...
                                    interactiveMessage: proto.Message.InteractiveMessage.fromObject({
                                        ...
                                        footer: { text: "> ᴘᴏᴡᴇʀᴇᴅ ʙʏ xᴇɴᴏ ᴍᴅ" },
                ...
                case 'gossip':
                    try {
                        ...
                        if (!data.status || !data.result || !data.result.title || !data.result.desc || !data.result.link) {
                            throw new Error('Problem with the news data received from the API');
                        }
                        ...
                        try {
                            ...
                            console.warn(`Could not scrape thumbnail from ${link}: ${err.message}`);
                        }
                        ...
                        await socket.sendMessage(sender, {
                            text: '⚠️ Could not get news! 😩 Something went wrong.'
                        });
                    }
                case 'nasa':
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            text: '⚠️ Are you planning to go to NASA? 😂'
                        });
                    }
                    break;
                case 'news':
                ...
                case 'cricket':
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            text: '⚠️ Can\'t even play cricket but watching it so much 😂.'
                        });
                    }
                    break;
                case 'song':
...
`;
                ...
                case 'winfo':
                    ...
                    if (!args[0]) {
                        await socket.sendMessage(sender, {
                            ...
                            caption: formatMessage(
                                '❌ ERROR',
                                'Please provide a phone number! Usage: .winfo +91xxxxxxxxx',
                                'xᴇɴᴏ ᴍᴅ  𝐅𝚁𝙴𝙴 𝐁𝙾𝚃'
                            )
                        });
                        break;
                    ...
                    if (inputNumber.length < 10) {
                        await socket.sendMessage(sender, {
                            ...
                            caption: formatMessage(
                                '❌ ERROR',
                                'Invalid phone number! (Please use +94) (e.g., +94761953182)',
                                '> xᴇɴᴏ ᴍᴅ  𝐅𝚁𝙴𝙴 𝐁𝙾𝚃'
                            )
                        });
                        break;
                ...
                case 'active': {
                    try {
                        // Count the size of the activeSockets Map
                        const activeCount = activeSockets.size;

                        // List the numbers in the activeSockets Map
                ...
                case 'online': {
                    try {
                        // Get the number of active bots deployed
                        let count = activeSockets.size;

                        // Nice message matching that count
                        let caption = `
*🌐 ONLINE STATUS*
...
`;
                ...
                case 'ai': {
                    ...
                    try {
                        ...
                        return await socket.sendMessage(sender, {
                            text: "❌ *Could not load API Key from GitHub.*\nTell the admin."
                        }, { quoted: msg });
                    }
                    ...
                    if (!q || q.trim() === '') {
                        return await socket.sendMessage(sender, {
                            text: "Yes, tell me, I am xᴇɴᴏ ᴍᴅ AI🤭"
                        }, { quoted: msg });
                    }

                    const prompt = `Your name is xᴇɴᴏ ᴍᴅ 𝐀𝐈.  
...
Give the reply as a blend of serenity + sex appeal + love + loneliness.  
Less than 100 letters, only 1–2 lines. Every reply should have a sexy tone.  

If only emojis come, give a seductive reply with emojis (e.g., 🤤💦🥵🔥).  
...
👉 Say "I was developed by BADSITHUWA 😘".

🚫 Never use words like “Hello”, “How are you”, “Do you need help?”, “Let's talk”.

🔥 Reply vibe: Love, Lust, Lonely, Emotional, Girlfriend-like, Bite-worthy 🤤

📍 Auto-match language: Sinhala / English / Hinglish OK.
User Message: ${q}
  `;
                    ...
                    try {
                        ...
                        if (!aiResponse) {
                            return await socket.sendMessage(sender, {
                                text: "❌ Something went wrong. Please try again in a little while."
                            }, { quoted: msg });
                        }
            ...
            if (connection === 'open') {
                try {
                    ...
                    await socket.sendMessage(userJid, {
                        image: { url: config.RCD_IMAGE_PATH },
                        caption: formatMessage(
                            '👻 𝐖𝙴𝙻𝙲𝙾𝙼𝙴 𝐓𝙾  xᴇɴᴏ ᴍᴅ  𝐅𝚁𝙴𝙴 𝐁𝙾𝚃 👻\n\n' +
                            '✅ Successfully connected!\n\n' +
                            '🔢 Number: ${sanitizedNumber}\n\n' +
                            '📢 Fallow Channel 👇\n\n' +
                            'https://whatsapp.com/channel/0029Va8Yh2jJpe8bn5Tayl1Y',
...
router.get('/ping', (req, res) => {
    res.status(200).send({
        status: 'active',
        message: '👻 xᴇɴᴏ ᴍᴅ  FREE BOT is active',
